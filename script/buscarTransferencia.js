			...
			columns: [
				{
					...
					template: function() {
						return '\
						<a \
						class="btn btn-sm btn-clean btn-icon btn-icon-md ver" title="Fix2" href="buscarTransferencia2.html" onclick=\'avanzarTransferencia()\'>\
							<i class="la la-eye"></i>\
						</a>';
					},
				}],
